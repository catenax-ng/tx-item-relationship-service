...
/**
 * InMemory storage for endpoint data references. Values are held either by assetId or contractAgreementId.
 */
...
public class EndpointDataReferenceStorage {
    ...
    public Optional<EndpointDataReference> get(final String storageId) {
        return Optional.ofNullable(storageMap.get(storageId).getDataReference());
    }
