    ...
    public List<CompletableFuture<EndpointDataReference>> getEndpointReferencesForAsset(final String endpointAddress,
        ...
        return contractOffers.stream().map(contractOffer -> {
            ...
            try {
                ...
                //     This is just for quickly simulating and experimenting with negotiation failed during development.
                //     It should later be replaced with a real automated test in IrsWireMockIntegrationTest that
                //     simulates this (this test could probably be based on shouldStartRecursiveProcesses but needs
                //     different setup throwing an exception during negotiation).
                //        if (true) {
